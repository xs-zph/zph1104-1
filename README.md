...
项目的每次功能迭代都会记录目标、根因、核心改动、验证结果和遗留问题：

- [任务总结.md](任务总结.md)：快速查看完整迭代总账，适合项目回顾和面试准备
- [任务总结模板.md](任务总结模板.md)：新增任务时使用的固定格式
- [解决日记.md](解决日记.md)：查看用户问题、排查过程和解决方案
- [task_plan.md](task_plan.md)：查看当前阶段和后续任务
